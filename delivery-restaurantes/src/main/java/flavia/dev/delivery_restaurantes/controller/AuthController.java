...
import flavia.dev.delivery_restaurantes.request.LoginRequest;
import flavia.dev.delivery_restaurantes.request.ResetPasswordRequest;
import flavia.dev.delivery_restaurantes.response.ApiResponse;
import flavia.dev.delivery_restaurantes.response.AuthResponse;
...
import flavia.dev.delivery_restaurantes.service.impl.ClienteUserServiceImpl;
...
public class AuthController {
	...
	private ClienteUserServiceImpl clienteUserServiceImpl;
	...
	public AuthController(UserRepository userRepository, 
			...
			ClienteUserServiceImpl clienteUserServiceImpl,
		...
		this.clienteUserServiceImpl = clienteUserServiceImpl;
	...
	public ResponseEntity<AuthResponse> createUserHandler(@Valid @RequestBody User user) throws UserException {
		...
		createdUser.setNomeCompleto(nomeCompleto);
...
//		savedUser.setCart(savedCart);
	...
	private Authentication authenticate(String username, String password) {
		UserDetails userDetails = clienteUserServiceImpl.loadUserByUsername(username);
